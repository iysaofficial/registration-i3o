...
function IndonesiaOnline() {
  ...
  useEffect(() => {
    ...
    if (!termsAccepted) {
      alert("Accept the Terms & Conditions to proceed.");
      ...
      <section className="registration-section">
        <div class="container">
          <div class="content">
            ...
            <p>
              3. There will be an email notification that the registration has been received, sent to the team leader's email address, and the documents will be validated by our team. Please be patient and wait a maximum of 3 days after the registration period; the Letter of Acceptance (LOA) will be sent to the team leader's email address.
            </p>
            <br />
            ...
            <form name="regist-form">
              ...
              <div className="user-details">
                <div className="input-box">
                  <label htmlFor="NAMA_LENGKAP" className="form-label">
                    Full Name of Team Leader & Members
                  </label>
                  <label>
                    <p>
                      Enter the full name of the team leader and members with the team leader's name first,
                  ...
                  <textarea
                    ...
                    name="NAMA_LENGKAP"
                    className="form-control"
                    placeholder="Input Full Name of Team Leader & Members"
                    required
                ...
                <div className="input-box">
                  ...
                  <label>
                    ...
                    <p>
                      Notes : Please fill in the team leader's number correctly, to be included in the WhatsApp group
                    </p>
                  </label>
                  <input
                    type="number"
                    ...
                    className="form-control"
                    placeholder="Input Your Leader Team's WhatsApp Number"
                    required
                  />
                </div>
                <div class="input-box">
                  <label for="LEADER_EMAIL" class="form-label">
                    Leader Team's Email Address
                  </label>
                  <label>
                    <p>
                ...
                <div className="input-box">
                  ...
                  <label>
                    <p>
                      Notes : Input NISN / NIM in accordance with the order of names of the team leader and members, in the following format :
                    </p>
                    <h6>231700</h6>
                    <h6>241700</h6>
                    <h6>251700</h6>
              ...
              <div className="user-details">
                <div className="input-box">
                  ...
                  <label>
                    <p>
                      Notes : Enter the school name in accordance with the order of names of the team leader and members from their respective schools, in the following format :
                    </p>
                    <h6>SMA CERIA</h6>
                    <h6>SMA BAHAGIA</h6>
                ...
                <div className="input-box">
                  ...
                  <label>
                    <p>
                      Notes : Enter the NPSN if you are still in school according to the order of names of the team leader and members, in the following format :
                    </p>
                    <h6>1201301</h6>
                    <h6>1302402</h6>
                    <h6>1020100</h6>
              ...
              <div className="user-details">
                <div className="input-box">
                  ...
                  <label>
                    <p>
                      Notes : Please fill in the project title data CORRECTLY, the submitted data cannot be changed!
                    </p>
                  </label>
                  <textarea
                    type="text"
